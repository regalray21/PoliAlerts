...
export const metadata: Metadata = {
  title:
    "PoliAlerts | Government Intelligence for Canadian Professionals",
  description:
    "Real-time monitoring of legislative sessions, regulatory filings, and policy changes across every province and territory. AI briefings, media intelligence, and lobbying data — all in one platform.",
};
    ...
    <>
      ...
      <div className="hidden lg:block relative">
        ...
        <img
          ...
          alt="Parliament buildings in Toronto"
        />
      </div>
      ...
      <section className="md:my-16 my-8 h-full px-5 lg:px-10 xl:px-24">
        ...
        <p className="text-sm md:text-base text-clifford md:leading-7 leading-[1.625rem] max-w-3xl">
          A minister mentioned your client&apos;s sector in committee. A new
          regulatory filing dropped that affects your industry. And a reporter
          published a story quoting your competitor. You found out about none of
          them until the next day. PoliAlerts makes sure that never happens again.
        </p>
      </section>
        ...
        <div className="md:w-[48%] w-full rounded-full md:my-0 my-10">
          <div className="rounded-r-full w-[90%]">
            ...
            <img
              ...
              alt="People moving through a government building"
            />
          </div>
        </div>
            ...
            <div className="p-4 md:w-[60px] flex justify-center items-center rounded-full bg-background-light-gray md:h-[60px]">
              <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33.97 33.08">
                <g>
                  ...
                  <path fill="#2468cd" d="m21.6,28.25c-.97.42-2,.72-3.08.88v3.95c1.78-.21,3.47-.71,5.04-1.44,0,0-1.96-3.39-1.96-3.39Z" />
                  <path fill="#2468cd" d="m32.13,22.35c.56-1.5.92-3.1,1.02-4.78h-3.91c-.07.97-.27,1.9-.55,2.8l3.43,1.98h0Z" />
                  <path fill="#2468cd" d="m26.96,23.88c-.59.84-1.28,1.61-2.05,2.29l1.98,3.43c1.34-1.06,2.51-2.33,3.47-3.75l-3.4-1.96h0Z" />
                  <path fill="#2468cd" d="m30.12,3.18l-.56,3.09c-3.04-3.82-7.71-6.27-12.96-6.27C7.44,0,0,7.45,0,16.6c0,8.48,6.4,15.49,14.62,16.47v-3.95c-6.06-.96-10.71-6.2-10.71-12.53,0-7,5.7-12.7,12.7-12.7,3.89,0,7.36,1.77,9.68,4.54l-2.97-.54-.7,3.84,9.61,1.74,1.74-9.61-3.84-.7v.02Z" />
                </g>
              </svg>
            </div>
            <h3 className="text-xl leading-[1.875rem] md:text-[1.625rem] md:leading-[2.375rem] font-bold text-black-text">
              Live sessions, transcribed as they happen
            </h3>
          </section>
          <section className="flex gap-4 items-center">
            <div className="p-4 md:w-[60px] flex justify-center items-center rounded-full bg-background-light-gray md:h-[60px]">
              <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47 49">
                <g>
                  ...
                  <polygon fill="#2468cd" points="38 18 27.58 18 27.58 21.5 0 21.5 0 27.5 27.58 27.5 27.58 31 38 31 38 27.5 47 27.5 47 21.5 38 21.5 38 18" />
                  <polygon fill="#2468cd" points="25 36 14.58 36 14.58 39.5 0 39.5 0 45.5 14.58 45.5 14.58 49 25 49 25 45.5 47 45.5 47 39.5 25 39.5 25 36" />
                </g>
              </svg>
            </div>
            <h3 className="text-xl leading-[1.875rem] md:text-[1.625rem] md:leading-[2.375rem] font-bold text-black-text">
              Alerts the moment your keywords come up
            </h3>
          </section>
          <section className="flex gap-4 items-center">
            <div className="p-4 md:w-[60px] flex justify-center items-center rounded-full bg-background-light-gray md:h-[60px]">
            ...
            <h3 className="text-xl leading-[1.875rem] md:text-[1.625rem] md:leading-[2.375rem] font-bold text-black-text">
              Every province, territory, and 100+ municipalities
            </h3>
          </section>
          <section className="flex gap-4 items-center">
            ...
            <h3 className="text-xl leading-[1.875rem] md:text-[1.625rem] md:leading-[2.375rem] font-bold text-black-text">
              AI briefings that read everything so you don&apos;t have to
            </h3>
          </section>
            ...
            <div className="flex gap-1 w-full items-center">
              <div className="flex w-[80%] justify-center items-start h-full flex-col gap-3 px-5 lg:px-10 xl:pl-24 xl:pr-[4.75rem]">
                ...
                <p className="text-clifford text-base leading-7 2xl:w-[80%]">
                  ...
                  are covering your issues and who they&apos;re quoting. Look up
                  any MP, minister, or official with direct contact info. See
                  who&apos;s lobbying on your topics and who has access to
                  decision-makers.
                </p>
      ...
      <section className="mobile lg:hidden block mt-5">
        <div className="flex flex-col px-5 py-8 gap-5 bg-background-light-gray">
          ...
          <h2 className="font-bold mb-2 text-black-text text-3xl leading-[2.625rem]">
            Your overnight analyst, your media radar, your contact book
          </h2>
          <p className="text-sm text-clifford leading-[1.375rem]">
            Every morning you get a personalized briefing that reads everything
            from yesterday and tells you what matters. Track which reporters are
            covering your issues. Look up any official with direct contact info.
            See who&apos;s lobbying on your topics.
          </p>
          ...
          <div className="mt-5">
            ...
            <p className="text-sm leading-[1.375rem] text-clifford mb-5">
              ...
              issues, who they quote, and what stories are gaining traction.
            </p>
          </div>
          <div>
            <h3 className="text-[1.375rem] leading-[1.875rem] font-bold mb-2 text-black-text">
            ...
            <p className="text-sm leading-[1.375rem] text-clifford mb-5">
              See the full landscape — who&apos;s lobbying, which officials
              they&apos;re meeting, registry filings, and ethics disclosures.
            </p>
          </div>
          <div>
            <h3 className="text-[1.375rem] leading-[1.875rem] font-bold mb-2 text-black-text">
            ...
            <p className="text-sm leading-[1.375rem] text-clifford mb-5">
              Updated directory of MPs, senators, provincial legislators, and
              political staff. Email, phone, social — all searchable.
            </p>
          </div>
        </div>
        ...
        <div className="relative md:h-[38rem] h-full w-full lg:hidden block">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-5">
            ...
            <p className="text-lg my-5 text-white-text leading-[1.875rem]">
              Join the professionals who never get blindsided by what government
              is doing.
            </p>
            <a
